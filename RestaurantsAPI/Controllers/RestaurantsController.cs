...
namespace RestaurantAPI.Controllers
{
    ...
    public class RestaurantsController : ControllerBase
    {
        ...
        {
            var url = "https://localhost:7259/api/Restaurants";
        ...
        // This endpoint is to get 16 restaurants
        [HttpGet("GetFeaturedRestaurants")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        ...
        // This endpoint is to get 12 local restaurants
        [HttpGet("GetLocalRestaurants")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> GetLocalRestaurants()
        {
            var restaurants = await _dbContext.Restaurants.Include(r => r.Reviews).Select(restaurant => new RestaurantResponse
            {
                RestaurantId = restaurant.RestaurantId,
        ...
        public async Task<IActionResult> GetNamesOfRestaurants()
        {
            ...
            var restaurants = await _dbContext.Restaurants.OrderBy(r => r.RestaurantName).ToListAsync();
